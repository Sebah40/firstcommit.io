...
const es: Record<TranslationKey, string> = {
  ...
  "connect.heroDesc": "Dile a Claude que publique y lee todo tu historial de conversación, identifica qué construiste y cómo, y crea una historia detallada de la que otros pueden aprender.",
  "connect.getStarted": "Empieza en 10 segundos",
  "connect.setupHint": "Ejecuta esto en cualquier proyecto donde uses Claude Code. Luego solo di",
  ...
  "connect.whatGetsPublishedDesc": "Claude lee tus sesiones y crea una historia de build detallada automáticamente.",
  ...
  "connect.featureNarrativeDesc": "Un resumen atractivo de qué se construyó y por qué — escrito por Claude con todo el contexto.",
